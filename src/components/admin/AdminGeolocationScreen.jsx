...
const talentLocations = [
  { id: 1, name: 'Dr. Ana Silva', role: 'Cardiologista Sênior', city: 'São Paulo', state: 'SP', position: [-23.5505, -46.6333], expertise: ['Cardiologia', 'Gestão'] },
  { id: 2, name: 'Enf. Bruno Costa', role: 'Enfermeiro Chefe UTI', city: 'Rio de Janeiro', state: 'RJ', position: [-22.9068, -43.1729], expertise: ['UTI', 'Emergência'] },
  ...
  { id: 4, name: 'Dr. Marcos Oliveira', role: 'Cirurgião Geral', city: 'Curitiba', state: 'PR', position: [-25.4284, -49.2733], expertise: ['Cirurgia', 'Auditoria'] },
  { id: 5, name: 'Dra. Sofia Pereira', role: 'Pediatra', city: 'Porto Alegre', state: 'RS', position: [-30.0346, -51.2177], expertise: ['Pediatria', 'Neonatal'] },
  { id: 6, name: 'Psic. Ricardo Alves', role: 'Psicólogo Clínico', city: 'Salvador', state: 'BA', position: [-12.9714, -38.5014], expertise: ['Clínica', 'Terapia Comportamental'] },
];
